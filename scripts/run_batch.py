    ...
    for group in folders:
        ...
        for v in videos:
            ...
            reentry_cfg = ReentryConfig(
                ...
                # spatial_disambig_v1 experiment: enabled for CAM1 side-view only.
                # When cross_person_ambiguous fires and the top candidate's last
                # position is spatially implausible, accept the second candidate
                # if it is spatially plausible and clears a score floor.
                spatial_disambig_enable=is_exact_cam1 and not is_full_cam1,
                spatial_disambig_max_speed_px_frame=180.0,
                spatial_disambig_top_implausible_factor=1.0,
